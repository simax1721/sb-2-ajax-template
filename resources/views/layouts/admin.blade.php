@php
    ...
    use App\Http\Middleware\AdminCek;

    $admin_access_menu = Admin_access_menu::where('admin_roles_id', AdminCek::get()->admin_roles_id)->get();
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        @foreach ($admin_access_menu as $access_menu)
            <div class="sidebar-heading">{{ $access_menu->admin_menu->name }}</div>
            @php
                $admin_sub_menu = Admin_sub_menu::where('admin_menus_id', $access_menu->admin_menus_id)->get();
                // dd($admin_sub_menu);
            @endphp
            <!-- Nav Item - Dashboard -->
            @foreach ($admin_sub_menu as $submenu)
                <li class="nav-item ">
                    <a class="nav-link" href="{{ url($submenu->url) }}">
                        <i class="fas fa-fw {{ $submenu->icon }}"></i>
