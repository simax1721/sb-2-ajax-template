  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#dataTableSubMenu').DataTable({
        ...
        columns: [
          {data:'admin_menus_id',name:'admin_menus_id'},
          {data:'name',name:'name'},
          {data:'url',name:'url'},
          {data:'icon',name:'icon'},
          {data:'action',name:'action', orderable: false, searchable: false},
  ...
  <div class="modal-dialog modal-lg" >
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  <label for="icon_submenu" class="control-label">Icon</label>
                  <input type="text" class="form-control" id="icon_submenu" name="icon_submenu" placeholder="">
              </div>
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-x"></i></button>
...
<script>
  ...
  $('#store_submenu').click(function (e) { 
      ...
      let icon   = $('#icon_submenu').val();
      let url   = $('#url_submenu').val();
      let admin_menus_id   = $('#admin_menu_list').val() == null ? '' : $('#admin_menu_list').val();
      let token   = $("meta[name='csrf-token']").attr("content");
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" id="admin_sub_menus_id">
              ...
              <div class="form-group">
                  <label for="icon_submenu_edit" class="control-label">Icon</label>
                  <input type="text" class="form-control" id="icon_submenu_edit" name="icon_submenu_edit" placeholder="">
              </div>
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-x"></i></button>
...
<script>
  ...
  $('body').on('click', '#btn-edit-submenu', function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $('#admin_menu_list_old').val(response.data.admin_menus_id);
          
          $('.admin_menu_list_edit').select2({
            placeholder: `${response.data.admin_menu.name}`,
            dropdownCssClass: "bigdrop",
  ...
  $('#update_submenu').click(function (e) { 
      ...
      let icon   = $('#icon_submenu_edit').val();
      let url   = $('#url_submenu_edit').val();
      let admin_menus_id   = $('#admin_menu_list_edit').val() == null ? $('#admin_menu_list_old').val() : $('#admin_menu_list_edit').val();
      let token   = $("meta[name='csrf-token']").attr("content");

      console.log(admin_menus_id, name, icon, url, admin_menus_id);
