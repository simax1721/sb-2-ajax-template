...
<!-- Page Heading -->
<h1 class="h3 mb-0 text-gray-800 mb-4"> Admin User</h1>
    ...
    <div class="col-md-12">
      <div class="mt-3 mb-3">
        <button class="btn btn-primary w-100" id="btn-create">
          <i class="icon fas fa-plus pr-1"></i> Admin User</button>
      </div>

    <div class="card shadow mb-4">
      <div class="card-header py-3">
          <h6 class="mt-2 font-weight-bold text-primary">Data Admin User</h6>
      </div>
      <div class="card-body">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name_edit" name="name_edit" readonly placeholder="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="password_edit" name="password_edit" readonly placeholder="********">
        </div>
        <div class="form-group">
